...
moduledecl: ($) => choice(seq('{',optional($.semis),optional($.imports),'}',optional($.semis),),seq($.semis,optional($.imports),),),
imports: ($) => seq(repeat1(seq($.importdecl,$.semis1,)),optional($.eimports),),
